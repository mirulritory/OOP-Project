...
public class Register extends JFrame {
    ...
    public Register() {
        ...
        // Labels, text fields, and buttons setup
        ...
        btnNewButton.setBackground(new Color(0, 191, 255)); // Deep Sky Blue color
        ...
        btnNewButton_1.setBackground(new Color(0, 191, 255)); // Deep Sky Blue color
        ...
        // GroupLayout configuration for horizontal and vertical groupings
