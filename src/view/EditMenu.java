...
public class EditMenu extends JFrame {
    ...
    public EditMenu() {
        ...
        JButton btnEdit = new JButton("Back");
        ...
        btnEdit.setBounds(160, 222, 89, 23);
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (selectedRow != -1) {
                    ...
                    if (option == JOptionPane.YES_OPTION) {
                        ...
                        try {
                            int rowsAffected = menuController.deleteMenu(drinkID);
                            ...
                            if (rowsAffected > 0) {
                                ...
                                JOptionPane.showMessageDialog(contentPane, "Error deleting item.");
                            }
                        } catch (ClassNotFoundException | SQLException ex) {
                            JOptionPane.showMessageDialog(contentPane, "Error deleting item: " + ex.getMessage(), "Error", JOptionPane.ERROR_MESSAGE);
                            ex.printStackTrace();
                        }
                    }
                } else {
